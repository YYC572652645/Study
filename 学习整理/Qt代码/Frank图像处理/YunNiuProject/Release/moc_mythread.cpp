...
#include "../../YunNiuProject/mythread/mythread.h"
...
QT_MOC_LITERAL(3, 26, 5), // "flage"
QT_MOC_LITERAL(4, 32, 4) // "data"

    },
    "CompareThread\0sendString\0\0flage\0data"
};
...
void CompareThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendString((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (CompareThread::*_t)(int , QString );
...
// SIGNAL 0
void CompareThread::sendString(int _t1, QString _t2)
{
