...
#include "../../StudentDataBase/workthread.h"
...
QT_MOC_LITERAL(1, 11, 9), // "dataCount"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 10), // "dataStruct"
QT_MOC_LITERAL(4, 33, 12) // "StudentData*"

    },
    "WorkThread\0dataCount\0\0dataStruct\0"
    "StudentData*"
};
...
void WorkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->dataStruct((*reinterpret_cast< StudentData*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkThread::dataCount)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (WorkThread::*_t)(StudentData * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkThread::dataStruct)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WorkThread::dataCount(int _t1)
{
...
// SIGNAL 1
void WorkThread::dataStruct(StudentData * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
